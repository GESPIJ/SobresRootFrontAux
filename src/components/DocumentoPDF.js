...
const MyDocument = () => (
  <PDFViewer height="780px" width="780px">
    <Document title={"Don Quijote de la Mancha"}>
      <Page style={styles.body} wrap size="A4">
        ...
        <Text style={styles.text}>
          ...
          fuesen más que un arminio; y con esto se quietó y prosiguió su camino,
          sin llevar otro que aquel que su caballo quería, creyendo que en
